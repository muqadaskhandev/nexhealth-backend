...
from app.routers import appointment_types, auth, booking_form, campaigns, communications, ehr, invites, locations, platform, practice, providers, public_booking, public_forms, public_reminders, public_reviews, public_waitlist, staff, sso, users, waitlist_requests
...
app.include_router(waitlist_requests.router)
